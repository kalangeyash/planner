...
export function ProjectDashboard({
  ...
  const handleSaveProject = () => {
    const newSavedProjects = [...savedProjects, { ...projectData, savedAt: new Date() }];
  ...
  const handleExportProject = () => {
    ...
    a.href = url;
    a.download = `${projectData.name.toLowerCase().replace(/\s+/g, '-')}-plan.json`;
  ...
  const calculateRiskLevel = () => {
    ...
    const highRisks = projectData.insights.risks.technical.filter((r: any) => r.severity === 'High').length +
    ...
    >
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p className="text-2xl font-bold">{Math.round(metric.value)}%</p>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Key project information and details</CardDescription>
        </CardHeader>
        <CardContent>
