  ...
  return (
    <div className=" flex justify-center align-middle min-h-screen w-screen bg-background">
      <nav className="fixed w-full top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container ml-60 flex h-14 items-center justify-between">
          <motion.div
      ...
      <main className="container pt-24 pb-8 min-h-screen">
        ...
        >
          ...
          <Button size="lg" onClick={() => onNavigate("form")} className="mt-4">
            Start Planning
          </Button>
        </motion.div>
          ...
          {[
            {
              ...
              description:
                "Get intelligent recommendations based on your project requirements",
            },
            {
              icon: Code2,
              title: "Tech Stack Analysis",
              description:
                "Discover the perfect technology combination for your needs",
            },
            {
              icon: Timer,
              title: "Timeline Planning",
              description:
                "Detailed project timelines with realistic milestones",
            },
            {
              icon: Rocket,
